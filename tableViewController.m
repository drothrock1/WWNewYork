...
- (void)viewDidLoad {
	...
	NSDictionary *row1 = [[NSDictionary alloc] initWithObjectsAndKeys:@"1. McSorley's Old Ale House", @"Name", @"15 East 7th Street",@"Address",@"nolactable1",@"Image", nil];
	NSDictionary *row2 = [[NSDictionary alloc] initWithObjectsAndKeys:@"2. St Mark's Church", @"Name", @"131 East 10th Street",@"Address",@"nolactable2",@"Image",  nil];	
	NSDictionary *row3 = [[NSDictionary alloc] initWithObjectsAndKeys:@"3. Brittany Hall", @"Name", @"55 East 10th Street",@"Address",@"nolactable3",@"Image",  nil];	
	NSDictionary *row4 = [[NSDictionary alloc] initWithObjectsAndKeys:@"4. House of Death", @"Name", @"14 West 10th Street",@"Address",@"nolactable4",@"Image",  nil];	
	NSDictionary *row5 = [[NSDictionary alloc] initWithObjectsAndKeys:@"5. Washington Square Park", @"Name", @"1 5th Avenue",@"Address",@"nolactable5",@"Image",  nil];	
	NSDictionary *row6 = [[NSDictionary alloc] initWithObjectsAndKeys:@"6. Poe House", @"Name", @"85 West 3rd Street",@"Address",@"nolactable6",@"Image",  nil];	
	NSDictionary *row7 = [[NSDictionary alloc] initWithObjectsAndKeys:@"7. Fire Patrol House #2", @"Name", @"84 West 3rd Street",@"Address",@"nolactable7",@"Image",  nil];	
	NSDictionary *row8 = [[NSDictionary alloc] initWithObjectsAndKeys:@"8. Brown Building of Science", @"Name", @"29 Washington Place",@"Address",@"nolactable8",@"Image",  nil];
	NSDictionary *row9 = [[NSDictionary alloc] initWithObjectsAndKeys:@"9. The Merchant's House", @"Name", @"29 East 4th Street",@"Address",@"nolactable9",@"Image",  nil];
    NSDictionary *row10 = [[NSDictionary alloc] initWithObjectsAndKeys:@"10. Colonnade Row", @"Name", @"434 Lafayette Street",@"Address",@"nolactable10",@"Image",  nil];
    
	
	NSArray *array = [[NSArray alloc] initWithObjects:row1, row2, row3, row4, row5, row6, row7, row8, row9, row10, nil];
	self.listData = array;
