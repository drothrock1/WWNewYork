...
@interface PageEightViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageEightViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 8", @"");
...
- (void)viewDidLoad
{
	...
	[scrollView setContentSize:CGSizeMake(320, 2970)];
...
- (void) prevController {
	...
	PageSevenViewController *pagesevenVC = [[PageSevenViewController alloc] initWithNibName: @"PageSevenViewController" bundle:nil];
	...
	pagesevenVC.hidesBottomBarWhenPushed = YES;
	[navigationStack addObject:pagesevenVC];
...
-(void)loadAudioFile {
	...
	// Load the audio file
	if(player == nil){	
		NSString *audioFile = [NSString stringWithFormat:@"nolac8"];
