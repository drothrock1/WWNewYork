...
@interface PageFiveViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 5", @"");
...
- (void)viewDidLoad
{
	...
	[scrollView setContentSize:CGSizeMake(320, 2570)];
...
- (void) prevController {
	...
	PageFourViewController *pagefourVC = [[PageFourViewController alloc] initWithNibName: @"PageFourViewController" bundle:nil];
	...
	pagefourVC.hidesBottomBarWhenPushed = YES;
	[navigationStack addObject:pagefourVC];
...
-(void)loadAudioFile {
	...
	// Load the audio file
	if(player == nil){	
		NSString *audioFile = [NSString stringWithFormat:@"nolac5"];
