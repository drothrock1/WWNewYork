//
//  PageNineViewController.m
//  CocktailZenDC
//
//  Created by Diane on 7/26/10.
...
@interface PageNineViewController (ViewHandlingMethods)
- (void)prevController;
- (void)nextController;
...
@implementation PageNineViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    self.title = NSLocalizedString(@"Site 9", @"");
...
- (void)viewDidLoad
{
	...
	[scrollView setContentSize:CGSizeMake(320, 3250)];
...
- (void) prevController {
	...
	PageEightViewController *pageeightVC = [[PageEightViewController alloc] initWithNibName: @"PageEightViewController" bundle:nil];
	...
	pageeightVC.hidesBottomBarWhenPushed = YES;
	[navigationStack addObject:pageeightVC];
...
- (void) nextController {
	...
	PageTenViewController *pagetenVC = [[PageTenViewController alloc] initWithNibName: @"PageTenViewController" bundle:nil];
	// Copy the view controllers stack from the navigation controller
	NSMutableArray *navigationStack = [[NSMutableArray alloc] initWithArray:self.navigationController.viewControllers];
	...
	// Add the next view controller
	pagetenVC.hidesBottomBarWhenPushed = YES;
	[navigationStack addObject:pagetenVC];
...
-(void)loadAudioFile {
	...
	// Load the audio file
	if(player == nil){	
		NSString *audioFile = [NSString stringWithFormat:@"nolac9"];
